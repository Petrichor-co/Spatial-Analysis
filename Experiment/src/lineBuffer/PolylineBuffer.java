...
public class PolylineBuffer {
	public static String getLineBufferEdgeCoords(List<Point> coords, double radius) {
		// 参数处理
		// 分别生成左侧和右侧的缓冲区边界点坐标串
	 ...
	 * @return 缓冲区的边界坐标
	 */
	private static String getLeftBufferEdgeCoords(List<Point> coords, double radius) {
		// 参数处理
		if (coords.size() < 1)
			return "";
